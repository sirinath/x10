...
GML_JAR         = $(gml_lib)/native_gml_$(GML_ELEM_TYPE).jar
GML_NAT_OPT	= -classpath $(GML_JAR) -x10lib $(gml_path)/native_gml_$(GML_ELEM_TYPE).properties
...
$(target)_pami	: $(x10src) $(depend_src) 
		$(X10CXX) -g -x10rt pami $(GML_NAT_OPT) $(X10_FLAG) $< -o $@_$(GML_ELEM_TYPE) \
		-post ' \# $(POST_PATH) \# $(POST_LIBS)'
